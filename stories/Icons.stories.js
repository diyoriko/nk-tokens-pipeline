...
const USAGE = `<code style="color:${MUTED};font-size:10.5px">import { icons } from '@novakid/nk-tokens/icons'</code> · ` +
  `<code style="color:${MUTED};font-size:10.5px">@novakid/nk-tokens/icons/react</code> · ` +
